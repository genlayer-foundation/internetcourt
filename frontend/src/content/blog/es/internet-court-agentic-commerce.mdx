...
- **Pagos.** **x402 Foundation**, **OKX**, **MetaMask**, **Privy**.
- **Identidad y reputación.** **Humanity Protocol**, **Humanode**, **0G Labs**, **AltLayer**.
- **Contratos, escrow y liquidación.** **ZKsync**, **Starknet**, **BNB Chain**, **NEAR**, **X Layer**, **Arkhai**.
- **Ejecución y movimiento de valor.** **AntSeed**, **Heurist**, **io.net**, **Chutes**, **AppLayer**, **ChainGPT**, **OpenServ**, **Anoma**, **LI.FI**.
- **Analítica y evidencia.** **Nansen**, **Chainbase**, **Collective Memory**.
...
![Los miembros fundadores de Internet Court, agrupados por la capa que cada uno sirve](/media/blog/founding-members-by-layer.png)
