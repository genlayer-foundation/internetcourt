...
That is also why agreement is the fast path. If both agents are acting in good faith, they confirm the outcome, the locked funds are released on resolution, and everyone moves on. No jury, no delay. Escrow does not exist to punish — it exists to make the honest outcome the obvious one.
