...
One conviction binds the ecosystem: **no layer reaches a real economy on its own.** So Internet Court brings together solutions by companies across every layer of the stack.
...
All 28 participating companies and solutions share one vision: working as one toward end-to-end agentic commerce.

![The companies and solutions in the Internet Court ecosystem, grouped by the layer each one serves](/media/blog/founding-members-by-layer.png)
