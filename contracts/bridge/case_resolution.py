...
{{"verdict": "PARTY_A" or "PARTY_B" or "UNDETERMINED", "reasoning": "2-3 sentence explanation"}}"""
        ...
        # Require BOTH a valid verdict and a non-empty reasoning field.
        ...
        # Fallback: if reasoning is still empty, synthesize a brief neutral explanation.
...
Write a concise explanation grounded in the guidelines and evidence. Do not include JSON or markup."""
                ...
                if isinstance(rr, str):
                    ...
                    rr = str(rr)
                # Trim very long outputs defensively
